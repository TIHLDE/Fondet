...
const Header: React.FunctionComponent = () => {
  ...
  if (windowSize.width >= theme.breakpoints.values.md && drawerOpen) {
    setDrawerOpen(false);
  }
          ...
          <Toolbar disableGutters>
            <Container style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }} maxWidth='xl'>
              <Link
                ...
                <Box component='img' height={30} src={logo} />
                <Typography variant='h2' ml={1} my={0} fontSize='2rem' fontWeight='bold'>
                  Fondet
                </Typography>
              </Link>
