...
export type FondetLogoProps = {
  size: "small" | "large";
  className?: string;
};

const FondetLogo = ({ size, className }: FondetLogoProps) => {
  return (
    <svg
      ...
      <g id="g10" transform="matrix(1.3333333,0,0,-1.3333333,0,1340)">
        <g id="g12">
          <g clipPath="url(#clipPath18)" id="g14">
            ...
            {size === "large" && (
              <>
                {/* Replace TIHLDE text with Fondet */}
