...
function uploadFileDialog() {
  ...
  SpreadsheetApp.getUi()
    .showModalDialog(html, 'Last opp fil');
}

function uploadFile(obj) {
  var blob = Utilities.newBlob(Utilities.base64Decode(obj.data), obj.type, obj.name);

  var res = UrlFetchApp.fetch("https://us-central1-fondet.cloudfunctions.net/uploadFile", { method: 'post', payload: blob, contentType: obj.type, headers: { 'Authorization': `Bearer ${api_key}` } });
