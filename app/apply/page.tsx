                  ...
                  <table className="w-full min-w-[800px]">
                    <thead>
                      <tr className="border-b border-[hsl(217,62%,20%)]">
                        <th className="text-left py-3 px-4 text-white font-semibold w-32">Hvem søkte</th>
                        <th className="text-left py-3 px-4 text-white font-semibold w-48">Hva søktes om</th>
                        <th className="text-left py-3 px-4 text-white font-semibold w-24">Når</th>
                        <th className="text-left py-3 px-4 text-white font-semibold w-32">Søkt om</th>
                        <th className="text-left py-3 px-4 text-white font-semibold w-32">Innvilget</th>
                      </tr>
                    </thead>
                <tbody>
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Hovedstyret</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Kjøkken</td>
                    <td className="py-3 px-4 text-gray-300 w-24">15.05.2025</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1ntj1CTeBvdQlS9A7wbqB82ztLht0b4BA/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">80 150 kr</a></td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/109RuXdTPxf80oh7Dx7YmkmKqKdnauT8I/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">64 120 kr</a></td>
                  </tr>
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Sosialen</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Utmatrikuleringsball</td>
                    <td className="py-3 px-4 text-gray-300 w-24">12.02.2025</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1lTnpw6IlnvrYhGeY-y6k68E7Ql52ADxc/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">18 000 kr</a></td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/17114ru4Bah5wTGje-mXqDGCsm6ybYN1Z/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">6 000 kr</a></td>
                  </tr>
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Pythons Herrer</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Påmeldingsavgift</td>
                    <td className="py-3 px-4 text-gray-300 w-24">28.08.2024</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1rZ9hJ4cmOveQfBAYiuY88phxIV0H0gsV/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">19 800 kr</a></td>
                    <td className="py-3 px-4 text-red-400 w-32"><a href="https://drive.google.com/file/d/1fq_PAHbBx4vM8PP_WdDcwzOF_lcFNV4k/view?usp=drive_link" className="text-red-400 hover:text-red-300">Avslått</a></td>
                  </tr>
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Klatring</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Søtte til klatreutstyr</td>
                    <td className="py-3 px-4 text-gray-300 w-24">09.11.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1Y6iaCTCAL1OI1uQ4S60UpXoSbMQCtYPr/view?usp=sharing" className="text-blue-400 hover:text-blue-300">6 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Sosialen</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Støtte til julebord</td>
                    <td className="py-3 px-4 text-gray-300 w-24">12.10.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/15hFwKChu8wGsuuICddP7vDnXTiDEK4x5/view?usp=sharing" className="text-blue-400 hover:text-blue-300">60 241 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Klatring</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Klatrearrangement, Brattkort og utstyr</td>
                    <td className="py-3 px-4 text-gray-300 w-24">04.10.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1iDqVY6KlnDqhZaTcdFcIPvS7tDUBG_Fy/view?usp=share_link" className="text-blue-400 hover:text-blue-300">21 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Pythons Herrer</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Nye fotballer</td>
                    <td className="py-3 px-4 text-gray-300 w-24">26.09.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1Rc6fiIgSq7342fKGYi9Si_7ZFZyb9dVd/view?usp=drive_link" className="text-blue-400 hover:text-blue-300">10 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Redaksjonen</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Extra utgave av TÖDDEL</td>
                    <td className="py-3 px-4 text-gray-300 w-24">31.05.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/open?id=1cTwhA7kIEkMpLQG5BQrrzuDFjGUHR4IW&usp=drive_copy" className="text-blue-400 hover:text-blue-300">8 750 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    ...
                    <td className="py-3 px-4 text-gray-300 w-48">Merch for medlemmer</td>
                    <td className="py-3 px-4 text-gray-300 w-24">15.04.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1iDXNkcLdKW78D3ewCQH6r7TzYMfx7Yl9/view?usp=share_link" className="text-blue-400 hover:text-blue-300">3 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    ...
                    <td className="py-3 px-4 text-gray-300 w-48">Prisreduksjon gallabilletter</td>
                    <td className="py-3 px-4 text-gray-300 w-24">05.03.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1JOnuCaGeAwLSlTbHTrSGM5yCNWk4xYyz/view?usp=share_link" className="text-blue-400 hover:text-blue-300">45 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">JubKom</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Merfinansiering</td>
                    <td className="py-3 px-4 text-gray-300 w-24">02.02.2023</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1YcjiUlu5_TWd4ZUbJNml0Cs0_NHP0Rbu/view?usp=share_link" className="text-blue-400 hover:text-blue-300">60 000 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Pythons</td>
                    <td className="py-3 px-4 text-gray-300 w-48">Draktsett/treningsutstyr</td>
                    <td className="py-3 px-4 text-gray-300 w-24">03.08.2022</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/14m1ULrmOaTsw3RHODD9dAFKVuLh5PYY8/view?usp=sharing" className="text-blue-400 hover:text-blue-300">14 990 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    ...
                    <td className="py-3 px-4 text-gray-300 w-32">Kamerautstyr</td>
                    <td className="py-3 px-4 text-gray-300 w-32">05.06.2022</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1XaHta9jJ_1fQDOeWVPnre5BS6ILVd4U-/view?usp=sharing" className="text-blue-400 hover:text-blue-300">22 366 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Hovedstyret</td>
                    <td className="py-3 px-4 text-gray-300 w-32">Soundbokser med bæreseler</td>
                    <td className="py-3 px-4 text-gray-300 w-32">16.02.2022</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1yAPBzPhfMj3NZbgiBLJ0w84n462JH2ow/view?usp=sharing" className="text-blue-400 hover:text-blue-300">24 495 kr</a></td>
                  ...
                  <tr className="border-b border-[hsl(217,62%,15%)]">
                    <td className="py-3 px-4 text-gray-300 w-32">Hovedstyret</td>
                    <td className="py-3 px-4 text-gray-300 w-32">Ny fane for TIHLDE</td>
                    <td className="py-3 px-4 text-gray-300 w-32">09.11.2021</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1aMytRdz-MX7XY7wAjCYLm-M-K-SwFsKG/view?usp=sharing" className="text-blue-400 hover:text-blue-300">72 000 kr</a></td>
                  ...
                  <tr>
                    <td className="py-3 px-4 text-gray-300 w-32">TIHLDE Pythons</td>
                    <td className="py-3 px-4 text-gray-300 w-32">Nytt draktsett til bruk i studentligaen</td>
                    <td className="py-3 px-4 text-gray-300 w-32">23.09.2021</td>
                    <td className="py-3 px-4 text-gray-300 w-32"><a href="https://drive.google.com/file/d/1P7NbilpTnR6jevfBfIYv40zEDFBpikrJ/view?usp=sharing" className="text-blue-400 hover:text-blue-300">9 670 kr</a></td>
